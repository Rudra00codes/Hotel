    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl font-sinoreta font-extrabold text-gray-900 mb-6">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-sinoreta font-bold text-center text-gray-900 mb-16">
            Navbar Features
          </h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm rounded-xl p-8 shadow-lg border border-white/20">
              ...
              <h3 className="text-xl font-sinoreta font-semibold text-gray-900 mb-3">
                Dynamic Resizing
              </h3>
      ...
      <section className="py-20 px-4">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-sinoreta font-bold text-center text-gray-900 mb-12">
          ...
          {Array.from({ length: 8 }, (_, i) => (
            <div key={i} className="mb-8 p-8 bg-white/50 backdrop-blur-sm rounded-xl border border-white/20">
              <h3 className="text-xl font-sinoreta font-semibold text-gray-900 mb-4">
                Content Block {i + 1}
              </h3>
      ...
      <footer className="py-12 px-4 bg-gray-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-xl font-sinoreta font-semibold mb-4">
