...
const ProgressiveBlur = ({
  ...
  return (
    <div
      className={`pointer-events-none fixed left-0 w-full select-none z-10 ${className}`}
      style={{
        [isTop ? "top" : "bottom"]: 0,
        height,
        background: isTop
        ...
        maskImage: isTop
          ? `linear-gradient(to top, transparent, ${backgroundColor} 50%)`
          : `linear-gradient(to bottom, transparent, ${backgroundColor} 50%)`,
